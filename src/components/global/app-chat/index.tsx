...
// Define global type for chat system
declare global {
  interface Window {
    ssq?: ChatFunction;
    __ssc?: {
...
// Type definition for chat function
...
const AppChat = () => {
  ...
  const [isChatVisible] = useAtom(chatVisibleAtom);

  useEffect(() => {
    // Determine if chat system should be shown
    const shouldShowChat = !isMobile() && !isHideBrand && isChatVisible;
